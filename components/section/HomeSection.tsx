  ...
  return (
    <SectionContainer>
      <div className="w-full h-[calc(100vh-11rem)] flex items-center justify-center">
        <AnimationContainer>
          <div className="absolute top-32 md:top-60 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-green-100 text-green-800 text-xs sm:text-sm font-medium px-4 py-2 rounded-full shadow-md">
